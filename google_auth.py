...
# Module to read the client ID and the client secret from the google_auth.json
# file
import myenv
...
# LOGIN_URI = os.environ.get("FN_BASE_URI", default=False)
# CLIENT_ID = os.environ.get("FN_CLIENT_ID", default=False)
# CLIENT_SECRET = os.environ.get("FN_CLIENT_SECRET", default=False)
AUTH_REDIRECT_URI = myenv.getAuthRedirectURI()
LOGIN_URI = myenv.getLoginURI()
HOME_URI = myenv.getHomeURI()
CLIENT_ID = myenv.getCliendID()
CLIENT_SECRET = myenv.getClientSecret()
...
def google_auth_redirect():
    ...
    return flask.redirect(LOGIN_URI, code=302)
